  ...
  switch (lock_request) {
    ...
    default:
      throw std::runtime_error(
          "Esse objeto não possui intencional equivalente");
      break;
  }
}
  ...
  switch (lock_request) {
    ...
    case WRITE_LOCK:
      return {WRITE_LOCK,
              CERTIFY_LOCK,
              UPDATE_LOCK,
              INTENTIONAL_WRITE_LOCK,
              INTENTIONAL_UPDATE_LOCK,
              INTENTIONAL_CERTIFY_LOCK};
    case CERTIFY_LOCK:
      return {READ_LOCK,
              WRITE_LOCK,
              CERTIFY_LOCK,
              UPDATE_LOCK,
              INTENTIONAL_READ_LOCK,
              INTENTIONAL_WRITE_LOCK,
              INTENTIONAL_CERTIFY_LOCK,
              INTENTIONAL_UPDATE_LOCK};
    case UPDATE_LOCK:
    ...
    default:
      throw std::runtime_error(
          "Não faz sentido chamar essa função para esse tipo de bloqueio "
          "(incompatible lock error");
  }
}
